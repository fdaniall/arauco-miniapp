...
export async function GET() {
  const manifest = {
    ...
    miniapp: {
      ...
      description: "Arauco connects tree planting with carbon credits. Plant virtual trees as NFTs, track your environmental impact, and join the sustainable blockchain future on Base.",
      screenshotUrls: [
      ...
      tagline: "Plant trees, earn credits",
      ogTitle: "Arauco",
      ogDescription: "Plant virtual trees as NFTs and earn carbon credits on Base blockchain. Join us today.",
